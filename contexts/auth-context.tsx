...
const initialPosts: Post[] = [
  {
    ...
    description:
      "Clean and modern brand identity design for a tech startup. Focused on simplicity and elegance with geometric shapes and bold typography.",
    image: "/images/minimalist-brand.png",
    tags: ["branding", "logo", "minimalist", "design"],
    likes: 124,
    comments: 18,
